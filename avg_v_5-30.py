...
class ChannelEngine:
    ...
    def get_trajectory_average_rate(self, Q, U, eta=0.6):
...
if __name__ == "__main__":
    ...
    for mc in range(NUM_MC):
        ...
        for i_v, v_val in enumerate(speeds):
            ...
            try:
                ...
                pso_opt.V = v_val;
                pso_opt.T_total = 2 * R / v_val
                if hasattr(pso_opt, 'time_points_opt'): pso_opt.time_points_opt = np.linspace(0, pso_opt.T_total, 10)
    ...
    algo_names = ['Initial ', 'Math (SCA/SCP)', 'PSO', 'Genetic (GA)']
